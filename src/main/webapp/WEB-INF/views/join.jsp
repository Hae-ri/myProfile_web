						...
						<table border="0" cellpadding="0" cellspacing="20">
							<form action="joinOk" method="post" name="reg_frm">
								...
								<tr>
									...
									<td align="center"><input type="password" name="pw_check" id="input-01"></td>
								</tr>
								<tr>
									<td class="td-type01">이름</td>
									<td align="center"><input type="text" name="name" id="input-01"></td>
								</tr>
								<tr>
									<td class="td-type01">이메일</td>
									<td align="center"><input type="email" name="email" id="input-01"></td>
								</tr>
								<tr>
